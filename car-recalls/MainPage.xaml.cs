...
namespace mtCarRecalls
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void ShareApplicationBar_Click(object sender, EventArgs e)  
        {
            ...
            shareLinkTask.Title = "Car Recalls";
        ...
        private void Browser_Navigating_1(object sender, NavigatingEventArgs e)
        {
            if (e.Uri.IsAbsoluteUri)
            {
                e.Cancel = true;
        ...
        {
            Browser.InvokeScript("showSearch");
        }
